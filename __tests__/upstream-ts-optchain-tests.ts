...
describe("ts-optchain", () => {
    ...
    it("optional chaining equivalence", () => {
        ...
        expect(oc(x).c[0].u.v()).toEqual(
            x.c && x.c[0] && x.c[0].u && (x as any).c[0].u.v,
        );
        expect(oc(x).c[100].u.v()).toEqual(
            x.c && x.c[100] && x.c[100].u && (x as any).c[100].u.v,
        );
        expect(oc(x).c[100].u.v(1234)).toEqual(
            (x.c && x.c[100] && x.c[100].u && (x as any).c[100].u.v) || 1234,
        );
        expect(oc(x).e.f()).toEqual(x.e && x.e.f);
        expect(oc(x).e.f("optional default value")).toEqual(
            (x.e && x.e.f) || "optional default value",
        );
        expect(oc(x).e.g(() => "Yo Yo")()).toEqual(
            ((x.e && x.e.g) || (() => "Yo Yo"))(),
        );
    });
});
